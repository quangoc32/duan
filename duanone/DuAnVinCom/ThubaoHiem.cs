    ...
    public partial class ThubaoHiem : Form
    {
        ...
        private void dgvTienBaoHiem_SelectionChanged(object sender, EventArgs e)
        {
            if (dgvTienBaoHiem.SelectedRows.Count > 0)
            {
                ...
                cbxTinhTrang.Text = selectedRow.Cells["TrangThai"].Value.ToString();
        ...
        private void dgvTienBaoHiem_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
